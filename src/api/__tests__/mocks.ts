 ...
 * Each returns a Response with appropriate status code.
 */
export const errorScenarios = {
  server500: (data: Record<string, unknown> = {}): Response =>
    mockResponse(data, false, 500),

  serviceUnavailable503: (data: Record<string, unknown> = {}): Response =>
    mockResponse(data, false, 503),

  rateLimited429: (data: Record<string, unknown> = {}): Response =>
    mockResponse(data, false, 429),

  notFound404: (data: Record<string, unknown> = {}): Response =>
    mockResponse(data, false, 404),

  badRequest400: (data: Record<string, unknown> = {}): Response =>
